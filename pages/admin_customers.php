...
?>
<!doctype html><html><head><meta charset="utf-8"><title>Customers</title><link rel="stylesheet" href="assets/styles.css"></head>
<body><?php include 'parts/topbar.php'; ?>
<main class="container">
  <h2>Customers</h2>
  <p><a href="index.php?p=admin_customer_create">Create Customer</a></p>
  <table class="table"><thead><tr><th>ID</th><th>Name</th><th>Password</th><th>Package</th><th>Actions</th></tr></thead><tbody>
