...
<main class="container">
  ...
  <p><a class="create-btn" href="index.php?p=admin_worker_create">➕ Create Worker</a></p>
    ...
    <tbody>
      <?php while ($r = $res->fetch_assoc()): ?>
        <tr>
          ...
          <td>
            <a class="btn-edit" href="index.php?p=admin_worker_edit&id=<?= $r['id'] ?>">✏️ Edit</a>
            <a class="btn-delete" href="index.php?p=admin_worker_delete&id=<?= $r['id'] ?>"
               onclick="return confirm('Are you sure you want to delete this worker?')">🗑️ Delete</a>
          </td>
        </tr>
      <?php endwhile; ?>
    </tbody>
