...
if (empty($_SESSION['user']) || $_SESSION['user']['role'] !== 'worker') { header('Location: index.php?p=login'); exit; }
...
?>
<!doctype html><html><head><meta charset="utf-8"><title>My Profile</title><link rel="stylesheet" href="assets/styles.css"></head>
